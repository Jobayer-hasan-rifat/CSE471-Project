        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    @if($events->isEmpty())
                        <p class="text-center text-gray-500">No pending events found.</p>
                    @else
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                ...
                                                @if(Auth::user()->role === 'oca')
                                                    ...
                                                    <form action="{{ route('events.reject', $event) }}" method="POST" class="inline">
                                                        @csrf
                                                        <button type="submit" class="ml-2 text-red-600 hover:text-red-900">Reject</button>
                                                    </form>
                                                @endif
                                            </td>
                                        </tr>
