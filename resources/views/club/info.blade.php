            ...
            <script>
                function handlePhotoInput(input) {
                    ...
                    reader.onload = function(e) {
                        ...
                        const photo = dataURL.split(',')[1];
                        document.getElementById('editPhotoHidden').value = photo;
                    };
                    reader.readAsDataURL(file);
                }
            </script>
            <input type="hidden" name="photo" id="editPhotoHidden">
