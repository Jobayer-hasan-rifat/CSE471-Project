    ...
    <main class="p-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                ...
                <div class="space-y-4">
                    <div class="flex justify-between items-center">
                        ...
                        <span class="px-3 py-1 bg-yellow-100 text-yellow-800 rounded-full">{{ $pendingEvents }}</span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-gray-600 dark:text-gray-400">Approved Events</span>
                        <span class="px-3 py-1 bg-green-100 text-green-800 rounded-full">{{ $approvedEvents }}</span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-gray-600 dark:text-gray-400">Rejected Events</span>
                        <span class="px-3 py-1 bg-red-100 text-red-800 rounded-full">{{ $rejectedEvents }}</span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-gray-600 dark:text-gray-400">Total Budget Approved</span>
                        <span class="px-3 py-1 bg-blue-100 text-blue-800 rounded-full">৳{{ number_format($totalBudget, 2) }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex justify-between items-center p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                        <div>
                            <h4 class="font-medium text-gray-700 dark:text-gray-300">{{ $event->event_name }}</h4>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <a href="{{ route('admin.clubs.index') }}" class="inline-flex items-center justify-center px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg">
                    Manage Clubs
                </a>
                <a href="{{ route('admin.venues.index') }}" class="inline-flex items-center justify-center px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg">
                    Manage Venues
                </a>
                <a href="{{ route('admin.events.index') }}" class="inline-flex items-center justify-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg">
                    View Events
                </a>
            </div>
        </div>
